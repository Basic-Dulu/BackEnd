...
def seed_ingredients():
    ...
    ingredients = [
        ...
        Ingredient(
            ...
            benefit="Melembabkan Kulit, Mengurangi Kemerahan, Mengurangi Iritasi, Baik untuk Penyembuhan Bekas Luka",
            image="Allantoin.png",

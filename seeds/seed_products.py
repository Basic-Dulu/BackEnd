...
def seed_products():
    ...
    products = [
        Product(
            ...
            ingredient="Madecassoside, Tocopherol, Glycerin, Ceramind NP, Panthenol, Madecassoside, Aloe Barbadensis Leaf Extract, Allantoin, Dipotassium Glycyrrhizate",
        ...
        Product(
            ...
            suitable_for="Kulit Sensitif, Kulit Kering, Kulit Berjerawat, Kulit Kemerahan",
            ingredient="Madecassoside, Tocopherol, Glycerin, Ceramind NP, Panthenol, Aloe Barbadensis Leaf Extract, Allantoin, Dipotassium Glycyrrhizate",
            benefit="Menenangkan kemerahan & iritasi ringan, Memproteksi & memperkuat skin barrier, Mengunci kelembapan tanpa menutup pori-pori, Menjaga elastisitas kulit & mencegah tanda penuaan dini",
